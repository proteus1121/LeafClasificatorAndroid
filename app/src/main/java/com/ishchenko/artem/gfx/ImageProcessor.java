...
public class ImageProcessor extends View {
     ...
     */
    public ImageProcessor(Image myImage, Context context) {
        super(context);
        this.context = context;
